...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Step 5: If FileName and FilePath are provided, call the UploadDocument procedure
        IF @FileName IS NOT NULL AND @FilePath IS NOT NULL
        BEGIN
            EXEC UploadDocument @ApplicationID, @FileName, @FilePath;
        END;
